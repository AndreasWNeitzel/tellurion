...
<section class="contributing" id="contributing">
  ...
  <div class="contributing-body">
    ...
    <p>Reports are credited on the <a href="#corrections">corrections page</a>. Pull requests are welcome on the public repository, but opening an issue first is faster than going straight to a PR.</p>
  </div>
</section>
