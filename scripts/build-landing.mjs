...
<style>
body { max-width: 1200px; margin: 0 auto; padding: var(--space-4); font-family: ui-sans-serif, system-ui, sans-serif; background: #0a0a0c; color: var(--fg, #e8e8e8); }
...
footer { padding: var(--space-4) 0; color: var(--fg-muted); font-size: 12px; }
</style>
</head>
<body>
<div class="header">
