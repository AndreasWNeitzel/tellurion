// Stellar oscillation modes playground (scaffolded stub).
...
function drawSketch(t) {
  ...
  ctx.fillText('Stellar oscillation modes', 24, 36);
  ctx.font = '12px sans-serif';
  ctx.fillStyle = '#8b8c92';
  ctx.fillText('Sketch: spherical-harmonic l=2 m=0 surface displacement pattern.', 24, 58);
