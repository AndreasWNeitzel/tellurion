...
window.playground.getState = function () {
  return {
    fields: [
      { key: 'statistics', label: 'statistics', value: st.stat },
      { key: 'amplitude', label: 'coherent amplitude $\\alpha$', value: st.alpha, format: 'float' },
      { key: 'mean-n', label: 'mean occupation $\\langle n \\rangle$', value: expectationN(currentState()), format: 'float' },
    ],
  };
};
