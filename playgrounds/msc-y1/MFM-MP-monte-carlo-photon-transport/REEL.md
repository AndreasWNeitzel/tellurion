...
VO: the freed electrons deposit dose a short distance forward, producing the characteristic build-up.
VO: Full interactive version at tellurion.dev. Follow for one of these a day.
Caption: tellurion.dev

## On-screen text beats
- Monoenergetic photons enter a water slab…
- what you are seeing
- the physics
- try it yourself
- tellurion.dev
...
## Source
Attix, Introduction to Radiological Physics, Chapters 7 to 8; Klein and Nishina 1929.
