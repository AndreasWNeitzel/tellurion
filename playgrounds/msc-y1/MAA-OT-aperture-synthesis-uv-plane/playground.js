// Aperture Synthesis (UV plane) playground (scaffolded stub).
...
function drawSketch(t) {
  ...
  ctx.fillText('Aperture Synthesis (UV plane)', 24, 36);
  ctx.font = '12px sans-serif';
  ctx.fillStyle = '#8b8c92';
  ctx.fillText('Sketch: rotating UV-track ellipse plus three-source dirty image.', 24, 58);
