...
VO: An interactive tour of geodesics across three spacetimes.
...
VO: just outside, it escapes after a sharp deflection. The same geodesic machinery gives the ISCO at 6 M, the Kerr ergosphere, and the FLRW Hubble flow v = H0 d.
VO: Full interactive version at tellurion.dev. Follow for one of these a day.
Caption: tellurion.dev

## On-screen text beats
- A photon aimed just inside the critical i…
- what you are seeing
- the physics
- try it yourself
- tellurion.dev
