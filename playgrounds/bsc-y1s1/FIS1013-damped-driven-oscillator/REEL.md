...
VO: push off-rhythm and almost nothing happens. That selectivity is resonance, and how sharp it is depends on one number: the damping.
VO: Full interactive version at tellurion.dev. Follow for one of these a day.
Caption: tellurion.dev

## On-screen text beats
- Push a swing at just the right rhythm and…
- what you are seeing
- the physics
- try it yourself
- tellurion.dev
