...
window.playground.getState = function () {
  return {
    fields: [
      { key: 'theta', label: 'pendulum angle $\\theta$', value: st.theta, format: 'float' },
      { key: 'omega', label: 'angular velocity $\\omega$', value: st.omega, format: 'float' },
      { key: 'energy', label: 'total energy $E$', value: energy(st.theta, st.omega), format: 'float' },
    ],
  };
};
