...
Captured at: 2026-05-15T08:25:17.194Z
...
| F.visual | PASS | 189 colors, corner 0.006, hot 20.4% |
| G.deterministic | PASS | 0.000% drift |
| J.disk-over-under | PASS | warm pixels above=70 below=336 |
| K.banding | PASS | radial 2nd-diff RMS 0.0003 <= 0.0050 (range 0.050, 380 samples in starfield region) |
| L.doppler | PASS | near-side disk asymmetry 60.1% (left=18260 right=45725, y in [440,580]) |
| M.shadow-ring | PASS | shadow 126 px, photon ring spike +0.730 at +136 px above center |
| V1.disk-fills-frame | FAIL | edge means top=0.004 bot=0.184 left=0.032 right=0.481 (min >= 0.02) |
| V2.warm-color | PASS | mean hue 44.8 deg in outer disk (target 20-50, 157139 samples) |
| V3.doppler-3x | FAIL | bright/dim luminance ratio in mid-disk annulus = 1.37 (target >= 1.5, spec target >= 3) |
| V4.inner-blooms | PASS | inner-edge annulus bright-pixel fraction 39.2% (target >= 20%, 48724 samples) |
| V5.photon-ring | FAIL | ring lum 0.657 vs mid-disk 0.740 (target >= 1.2x) |
