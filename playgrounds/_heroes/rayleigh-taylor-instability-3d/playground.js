...
window.playground.getState = function () {
  return {
    fields: [
      { key: 'atwood', label: 'Atwood number $A$', value: st.A, format: 'float' },
      { key: 'growth-rate', label: 'linear growth rate $\\sigma$', value: growthRate(st.k, st.A, st.g), format: 'float' },
      { key: 'amplitude', label: 'perturbation amplitude', value: st.amplitude, format: 'float' },
    ],
  };
};
