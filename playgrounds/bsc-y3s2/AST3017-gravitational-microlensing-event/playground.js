// Microlensing event playground (scaffolded stub).
...
function drawSketch(t) {
  ...
  ctx.fillText('Microlensing event', 24, 36);
  ctx.font = '12px sans-serif';
  ctx.fillStyle = '#8b8c92';
  ctx.fillText('Sketch: Paczynski A(t) light curve with finite-source flattening.', 24, 58);
