// GW chirp sonification playground (scaffolded stub).
...
function drawSketch(t) {
  ...
  ctx.fillText('GW chirp sonification', 24, 36);
  ctx.font = '12px sans-serif';
  ctx.fillStyle = '#8b8c92';
  ctx.fillText('Sketch: scrolling sinusoid with increasing frequency and amplitude.', 24, 58);
