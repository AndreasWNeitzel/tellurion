...
window.playground.getState = function () {
  if (!state.swarm) return { fields: [] };
  return { fields: [
    { key: "impact-param-max", label: "Max impact parameter", value: state.bMax, format: "float" },
    { key: "photon-count", label: "Photon count N", value: state.N, format: "float" },
    { key: "steps", label: "Integration steps", value: state.stepsSoFar, format: "float" },
  ]};
};
