// Lensing caustics playground (scaffolded stub).
...
function drawSketch(t) {
  ...
  ctx.fillText('Lensing caustics', 24, 36);
  ctx.font = '12px sans-serif';
  ctx.fillStyle = '#8b8c92';
  ctx.fillText('Sketch: source-plane caustic curve plus image-plane critical curve.', 24, 58);
