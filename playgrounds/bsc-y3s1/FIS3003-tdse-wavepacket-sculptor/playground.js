...
window.playground.getState = function () {
  return {
    fields: [
      { key: 'norm', label: 'norm $\\langle\\psi|\\psi\\rangle$', value: norm(s), format: 'float' },
      { key: 'energy', label: 'energy $\\langle H \\rangle$', value: energy(s), format: 'float' },
      { key: 'position', label: 'position $\\langle x \\rangle$', value: expectationX(s), format: 'float' },
    ],
  };
};
