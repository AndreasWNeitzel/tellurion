...
two D lines blur into a single hump, you cannot resolve them. Push
the reflectance slider up. The peaks narrow (the finesse, shown in
the readout, climbs) and at some point the single hump cleanly splits
into two, the doublet resolved. The resolved flag in the readout
