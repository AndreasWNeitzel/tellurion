// LBM fluid painter playground (scaffolded stub).
...
function drawSketch(t) {
  ...
  ctx.fillText('LBM fluid painter', 24, 36);
  ctx.font = '12px sans-serif';
  ctx.fillStyle = '#8b8c92';
  ctx.fillText('Sketch: 2D vorticity field with circular obstacle and Von Karman wake.', 24, 58);
