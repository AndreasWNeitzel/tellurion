...
VO: you re-emerge in a region that is, in principle, arbitrarily far from where you entered. The price is exotic matter with negative energy density, which may or may not exist.
VO: Full interactive version at tellurion.dev. Follow for one of these a day.
Caption: tellurion.dev

## On-screen text beats
- A wormhole is a topological shortcut betw…
- what you are seeing
- the physics
- try it yourself
- tellurion.dev
