...
caption: 'Figure 1. Cosmology: a multi-mode laboratory for Friedmann expansion (Expansion, Fate), the CMB last-scattering surface (CMB), and slow-roll inflation (Inflation). Method: shared friedmann-cpu engine for a(t) (RK4 in cosmic time), a Canvas2D comoving galaxy lattice projected through an orbit camera with proper separations scaled by a(t), deterministic random temperature field for the CMB, closed-form slow-roll for the inflaton trajectory and (n_s, r) observables. Source: Ryden, Introduction to Cosmology, Ch. 5 - 6.'
...
references:
  - "Ryden, Introduction to Cosmology, 2nd ed., Ch. 5."
---
