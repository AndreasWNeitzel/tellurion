// Framebuffer with attached float texture. opts.depth = true adds a depth renderbuffer.
export function createFBO(gl, w, h, opts = {}) {
  const tex = gl.createTexture();
  gl.bindTexture(gl.TEXTURE_2D, tex);
  gl.texImage2D(gl.TEXTURE_2D, 0, opts.internalFormat ?? gl.RGBA16F, w, h, 0, gl.RGBA, opts.type ?? gl.HALF_FLOAT, null);
