...
| E. Doppler asymmetry > 20% | NOT IMPLEMENTED | Doppler factor g^4 is in the shader and visible in renders, but no automated luminance-by-side measurement exists yet. |
