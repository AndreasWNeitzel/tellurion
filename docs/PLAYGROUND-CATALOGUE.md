...
Generated by scripts/make-catalogue.mjs. Total 310 playgrounds: 305 shipped (folder has a .verified marker with a verified-at line), 5 Draft (no .verified, so build-index.mjs gates them out of the gallery), 305 post-build-swept (have DEVNOTES.md), 69 flagged hero_candidate.
