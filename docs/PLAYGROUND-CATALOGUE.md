...
Generated by scripts/make-catalogue.mjs. Total 309 playgrounds: 309 shipped (folder has a .verified marker with a verified-at line), 0 Draft (no .verified, so build-index.mjs gates them out of the gallery), 309 post-build-swept (have DEVNOTES.md), 65 flagged hero_candidate.
