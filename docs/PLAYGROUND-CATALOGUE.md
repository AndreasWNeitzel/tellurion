...
Generated by scripts/make-catalogue.mjs. Total 310 playgrounds: 304 shipped (folder has a .verified marker with a verified-at line), 6 Draft (no .verified, so build-index.mjs gates them out of the gallery), 304 post-build-swept (have DEVNOTES.md), 69 flagged hero_candidate.
