...
Generated by scripts/make-catalogue.mjs. Total 310 playgrounds: 278 shipped (folder has a .verified marker with a verified-at line), 32 Draft (no .verified, so build-index.mjs gates them out of the gallery), 47 post-build-swept (have DEVNOTES.md), 68 flagged hero_candidate.
...
### Slow-Roll Inflation
`playgrounds/bsc-y3s2/AST3017-inflation-slow-roll` | AST3017 | SHIPPED | tier:simple
