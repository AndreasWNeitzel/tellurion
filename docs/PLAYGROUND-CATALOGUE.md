...
Generated by scripts/make-catalogue.mjs. Total 310 playgrounds: 310 shipped (folder has a .verified marker with a verified-at line), 0 Draft (no .verified, so build-index.mjs gates them out of the gallery), 310 post-build-swept (have DEVNOTES.md), 67 flagged hero_candidate.
...
`playgrounds/bsc-y2s2/FIS2006-dipole-radiation-3d` | FIS2006 | SHIPPED | swept | tier:hero
