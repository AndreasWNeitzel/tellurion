...
Generated by scripts/make-catalogue.mjs. Total 310 playgrounds: 310 shipped (folder has a .verified marker with a verified-at line), 0 Draft (no .verified, so build-index.mjs gates them out of the gallery), 310 post-build-swept (have DEVNOTES.md), 66 flagged hero_candidate.
...
`playgrounds/bsc-y3s1/FIS3003-heisenberg-uncertainty-visualizer` | FIS3003 | SHIPPED | swept | tier:hero
