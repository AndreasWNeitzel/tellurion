...
Generated by scripts/make-catalogue.mjs. Total 310 playgrounds: 310 shipped (folder has a .verified marker with a verified-at line), 0 Draft (no .verified, so build-index.mjs gates them out of the gallery), 310 post-build-swept (have DEVNOTES.md), 68 flagged hero_candidate.
...
`playgrounds/bsc-y1s1/FIS1013-rigid-body-euler-3d` | F1006 | SHIPPED | swept | tier:hero
