...
Generated by scripts/make-catalogue.mjs. Total 310 playgrounds: 310 shipped (folder has a .verified marker with a verified-at line), 0 Draft (no .verified, so build-index.mjs gates them out of the gallery), 310 post-build-swept (have DEVNOTES.md), 69 flagged hero_candidate.
...
`playgrounds/bsc-y2s1/FIS2014-heat-equation-2d-gpu` | FIS2001 | SHIPPED | swept | tier:advanced
...
`playgrounds/bsc-y2s1/FIS2014-thermodynamic-engine-simulator` | FIS2001 | SHIPPED | swept | HERO-CANDIDATE | tier:hero
...
`playgrounds/bsc-y2s2/FIS2003-nuclear-decay-chain-animation` | FIS2003 | SHIPPED | swept | tier:advanced
...
`playgrounds/bsc-y2s2/FIS2003-photoelectric-effect-simulator` | FIS2003 | SHIPPED | swept | tier:advanced
...
`playgrounds/bsc-y2s2/FIS2003-quantum-double-slit-accumulator` | FIS2003 | SHIPPED | swept | HERO-CANDIDATE | tier:hero
...
`playgrounds/bsc-y2s2/FIS2003-special-relativity-spacetime-lab` | FIS2003 | SHIPPED | swept | HERO-CANDIDATE | tier:hero
...
`playgrounds/bsc-y2s2/FIS2006-fresnel-snell-3d-interface` | FIS2006 | SHIPPED | swept | HERO-CANDIDATE | tier:advanced
...
`playgrounds/bsc-y2s2/FIS2006-waveguide-mode-animator` | FIS2006 | SHIPPED | swept | tier:advanced
