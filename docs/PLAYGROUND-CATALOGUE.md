...
Generated by scripts/make-catalogue.mjs. Total 310 playgrounds: 298 shipped (folder has a .verified marker with a verified-at line), 12 Draft (no .verified, so build-index.mjs gates them out of the gallery), 183 post-build-swept (have DEVNOTES.md), 68 flagged hero_candidate.
