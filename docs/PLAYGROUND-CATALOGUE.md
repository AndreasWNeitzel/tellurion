...
Generated by scripts/make-catalogue.mjs. Total 310 playgrounds: 289 shipped (folder has a .verified marker with a verified-at line), 21 Draft (no .verified, so build-index.mjs gates them out of the gallery), 57 post-build-swept (have DEVNOTES.md), 68 flagged hero_candidate.
